...
exports.chooseBotName = (l) => {
    ...
    return exports.choose([
        'Generic Bot Name',
        'road to 1m',
        '[KPK] ' + exports.choose(names),
        '[base] ' + exports.choose(names),
        label + ' is op',
        'aeiou',
        'i hate teamers',
        'spin to team',
        'Developer',
        '[null] ' + exports.choose(names),
        '[water] ' + exports.choose(names),
        '[fire] ' + exports.choose(names),
        'You',
        '750k hunt',
        'buff ' + label,
        'never nerf ' + label,
